...
public class ArcanusEnglishLanguageProvider extends FabricLanguageProvider {
	...
	public void generateTranslations(HolderLookup.Provider registryLookup,TranslationBuilder builder) {
		...
		builder.add(SCREEN_SUPPORT_US_SUBTITLE, "Arcanus: Continuum");
		...
		builder.add(COMPENDIUM_ARCANUS_LANDING, "Arcanus: Continuum introduces a new magic system to the world of Minecraft. Players can create their own custom spells to suit however they like to play the game!");
		...
		builder.add(CONFIG_ENABLED, "Enabled (Requires Restart)");
		builder.add(CONFIG_WEIGHT, "Weight (Requires Restart)");
		builder.add(CONFIG_MANA_COST, "Mana Cost (Requires Restart)");
		builder.add(CONFIG_MANA_MULTIPLIER, "Mana Multiplier (Requires Restart)");
		builder.add(CONFIG_COOL_DOWN, "Cool Down (Requires Restart)");
		builder.add(CONFIG_MIN_LEVEL, "Minimum Level (Requires Restart)");
		builder.add(CONFIG_PROCS_ONCE, "Only Procs Once When Chained (Requires Restart)");
		builder.add(CONFIG_POTENCY_MODIFIER, "Potency Modifier (Requires Restart)");
		...
		builder.add(CONFIG_BASE_POWER, "Base Power");
		...
		builder.add(CONFIG_POWER_EFFECT_PROPERTIES, "Power Effect");
		...
		builder.add(CONFIG_MANA_WINGS_EFFECT_PROPERTIES, "Mana Wings Effect");
	}
