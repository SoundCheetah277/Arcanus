...
public class BattleMageArmourRenderer implements ArmorRenderer {
	...
	public void render(PoseStack matrices, MultiBufferSource vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, HumanoidModel<LivingEntity> contextModel) {
		...
		if(stack.getItem() instanceof BattleMageArmorItem battleMageArmorItem) {
			...
			model.renderToBuffer(matrices, ItemRenderer.getArmorFoilBuffer(vertexConsumers, RenderType.armorCutoutNoCull(mainTexture), false), light, OverlayTexture.NO_OVERLAY, 1f, 1f, 1f, 1f);
